        ...
        <div class="page-container">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered">
                                    <tr class="success">
                                      <td width="7%"><strong>Receipt No</strong></td>
                                        <td width="13%"><strong>Customer Name</strong></td>
                                        <td width="8%"><strong>Date Time</strong></td>
                                        <td width="10%">&nbsp;</td>
                                        <td width="10%">&nbsp;</td>
                                    </tr>
                                    <tr>
                                      <td>1</td>
                                        <td>SNA Tradings</td>
                                        <td>01-02-2017 3:00 PM</td>
                                        <td><a href="item-update.php">view</a></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                      <td>2</td>
                                        <td>Radiator-Toyota</td>
                                        <td>05-02-2017 4:00 PM</td>
                                        <td><a href="#">view</a></td>
                                        <td></td>
                                    </tr>
                                    <tr>
            ...
            <div class="sidebar-menu"> 
                ...
                <div class="down">	
                    ...
                    <a href="index.html"><span class=" name-caret">Saman
