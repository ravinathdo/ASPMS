...
<html>
            ...
            <div class="left-content">
                <div class="inner-content">
                    ...
                    <div class="outter-wp">
                        ...
                        <div class="row">
                          <div class="col-lg-10">Sales Receipt No : 1
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="28%">&nbsp;</td>
    <td width="72%">Automobile company name</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>01-01-2014 3:00 PM</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>215225</td>
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered">
      <tr class="success">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><input type="submit" value="Print Recipt"/></td>
  </tr>
</table>
